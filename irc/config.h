...
void irc_config_network_set_username(irc_config_network_t n, char const *p);
void irc_config_network_set_password(irc_config_network_t n, char const *p);
void irc_config_network_set_nickserv(irc_config_network_t n, char const *p);
...
char const *irc_config_network_username(irc_config_network_t n);
char const *irc_config_network_password(irc_config_network_t n);
